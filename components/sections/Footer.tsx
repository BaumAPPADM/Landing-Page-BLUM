    ...
    <footer style={s("background:#002E2B;padding:60px 5% 44px;")}>
      <div style={s("max-width:1100px;margin:0 auto 44px;display:grid;grid-template-columns:minmax(240px,1.5fr) repeat(3,minmax(150px,1fr));gap:40px;align-items:start;")}>
        <div>
          ...
          {" "}
          <a className="bh22" href="#contacto" style={s("display:inline-block;font-family:'Sora',sans-serif;font-size:13px;font-weight:700;color:#002E2B;background:#77CFC9;border-radius:22px;padding:10px 22px;")}>
        ...
        <div>
          ...
          <div style={s("display:flex;flex-direction:column;gap:10px;")}>
            <a className="bh23" href={d?.footerColumns?.[0]?.links?.[0]?.href || "#metodo"} style={s("font-family:'IBM Plex Sans',sans-serif;font-size:13.5px;color:rgba(255,255,255,0.75);")}>
              {d?.footerColumns?.[0]?.links?.[0]?.label || "Cómo funciona"}
            </a>
            {" "}
            <a className="bh24" href={d?.footerColumns?.[0]?.links?.[1]?.href || "#app"} style={s("font-family:'IBM Plex Sans',sans-serif;font-size:13.5px;color:rgba(255,255,255,0.75);")}>
              {d?.footerColumns?.[0]?.links?.[1]?.label || "Funcionalidades"}
            </a>
            {" "}
            <a className="bh25" href={d?.footerColumns?.[0]?.links?.[2]?.href || "#web"} style={s("font-family:'IBM Plex Sans',sans-serif;font-size:13.5px;color:rgba(255,255,255,0.75);")}>
              {d?.footerColumns?.[0]?.links?.[2]?.label || "App y Web"}
            </a>
            {" "}
            <a className="bh26" href={d?.footerColumns?.[0]?.links?.[3]?.href || "#planes"} style={s("font-family:'IBM Plex Sans',sans-serif;font-size:13.5px;color:rgba(255,255,255,0.75);")}>
        ...
        <div>
          ...
          {" "}
          <div style={s("display:flex;flex-direction:column;gap:10px;")}>
            <a className="bh27" href={d?.footerColumns?.[1]?.links?.[0]?.href || "#contacto"} style={s("font-family:'IBM Plex Sans',sans-serif;font-size:13.5px;color:rgba(255,255,255,0.75);")}>
        ...
        <div>
          ...
          {" "}
          <div style={s("display:flex;flex-direction:column;gap:10px;")}>
            <a className="bh29" href={d?.footerColumns?.[2]?.links?.[0]?.href || "https://apps.apple.com/cl/app/baumapp/id6751601274"} target="_blank" rel="noopener" style={s("display:inline-flex;align-items:center;gap:8px;font-family:'IBM Plex Sans',sans-serif;font-size:13.5px;color:rgba(255,255,255,0.75);")}>
            ...
            {" "}
            <a className="bh30" href={d?.footerColumns?.[2]?.links?.[1]?.href || "https://play.google.com/store/apps/details?id=com.baumsystem.baumapp"} target="_blank" rel="noopener" style={s("display:inline-flex;align-items:center;gap:8px;font-family:'IBM Plex Sans',sans-serif;font-size:13.5px;color:rgba(255,255,255,0.75);")}>
